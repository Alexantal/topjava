...
class MealRestControllerTest extends AbstractControllerTest {
    ...
    void getBetweenRest() throws Exception {
        List<Meal> dateFilteredMeals = service.getBetweenInclusive(LocalDate.of(2020, 1, 30),
                LocalDate.of(2020, 1, 30), SecurityUtil.authUserId());
        List<MealTo> expectedMealTo = MealsUtil.getFilteredTos(dateFilteredMeals, MealsUtil.DEFAULT_CALORIES_PER_DAY,
                LocalTime.of(11, 0, 0), LocalTime.of(22, 0, 0));

        perform(MockMvcRequestBuilders.get(REST_URL + "filter?startDateTime=2020-01-30T11:00:00&endDateTime=2020-01-30T22:00:00"))
                .andExpect(status().isOk())
                .andExpect(content().contentTypeCompatibleWith(MediaType.APPLICATION_JSON_VALUE))
                .andExpect(MEALTO_MATCHER.contentJson(expectedMealTo));
    }
}