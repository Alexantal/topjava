...
VALUES ('2020-01-30 10:00', 'Завтрак', 500, 100000),
       ...
       ('2020-01-30 10:00', 'Завтрак', 490,100001),
       ('2020-01-30 13:00', 'Обед', 1050, 100001),
       ('2020-01-30 20:00', 'Ужин', 400, 100001),
       ('2020-01-31 00:00', 'Еда на граничное значение', 100, 100001),
       ('2020-01-31 10:00', 'Завтрак', 1200, 100001),
       ('2020-01-31 13:00', 'Обед', 300, 100001),
